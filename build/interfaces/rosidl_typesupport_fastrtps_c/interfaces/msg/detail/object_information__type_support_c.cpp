...
#include "interfaces/msg/detail/object_information__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectInformation__ros_msg_type = interfaces__msg__ObjectInformation;
...
static uint32_t _ObjectInformation__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__ObjectInformation(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__ObjectInformation;
    is_plain =
      (
...
static size_t _ObjectInformation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__ObjectInformation(
