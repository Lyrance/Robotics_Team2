...
class Init_ObjectInformation_angle
{
public:
  explicit Init_ObjectInformation_angle(::package_with_interfaces::msg::ObjectInformation & msg)
  : msg_(msg)
  {}
  Init_ObjectInformation_detected angle(::package_with_interfaces::msg::ObjectInformation::_angle_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_ObjectInformation_angle z(::package_with_interfaces::msg::ObjectInformation::_z_type arg)
  {
    msg_.z = std::move(arg);
    return Init_ObjectInformation_angle(msg_);
  }
