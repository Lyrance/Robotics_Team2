...
#include "interfaces/msg/detail/object_information__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::ObjectInformation & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::ObjectInformation & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::ObjectInformation;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::ObjectInformation *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::ObjectInformation *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_ObjectInformation__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, ObjectInformation)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_ObjectInformation__handle;
}
