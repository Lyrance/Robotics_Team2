...
#include "package_with_interfaces/msg/detail/object_information__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const package_with_interfaces::msg::ObjectInformation & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  package_with_interfaces::msg::ObjectInformation & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = package_with_interfaces::msg::ObjectInformation;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const package_with_interfaces::msg::ObjectInformation *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<package_with_interfaces::msg::ObjectInformation *>(
    untyped_ros_message);
...
{
  return &package_with_interfaces::msg::typesupport_fastrtps_cpp::_ObjectInformation__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, package_with_interfaces, msg, ObjectInformation)() {
  return &package_with_interfaces::msg::typesupport_fastrtps_cpp::_ObjectInformation__handle;
}
