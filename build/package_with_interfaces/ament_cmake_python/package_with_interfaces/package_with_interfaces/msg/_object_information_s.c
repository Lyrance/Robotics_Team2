...
bool package_with_interfaces__msg__object_information__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("package_with_interfaces.msg._object_information.ObjectInformation", full_classname_dest, 65) == 0);
  }
  package_with_interfaces__msg__ObjectInformation * ros_message = _ros_message;
  {  // x
...
PyObject * package_with_interfaces__msg__object_information__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("package_with_interfaces.msg._object_information");
