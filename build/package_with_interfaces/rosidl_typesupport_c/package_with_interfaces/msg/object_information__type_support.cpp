...
static const _ObjectInformation_type_support_symbol_names_t _ObjectInformation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_with_interfaces, msg, ObjectInformation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, package_with_interfaces, msg, ObjectInformation)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, package_with_interfaces, msg, ObjectInformation)() {
  return &::package_with_interfaces::msg::rosidl_typesupport_c::ObjectInformation_message_type_support_handle;
}
