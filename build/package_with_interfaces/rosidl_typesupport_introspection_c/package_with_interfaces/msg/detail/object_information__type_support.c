...
static rosidl_typesupport_introspection_c__MessageMember package_with_interfaces__msg__ObjectInformation__rosidl_typesupport_introspection_c__ObjectInformation_message_member_array[5] = {
  {
    "x",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(package_with_interfaces__msg__ObjectInformation, angle),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
